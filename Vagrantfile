...
hostname        = "flarum.martinistam.dev"
...
Vagrant.configure("2") do |config|
  ...
  # Install Nodejs
  config.vm.provision "shell", path: "https://raw.githubusercontent.com/franzliedke/Vaprobash/patch-4/scripts/nodejs.sh", privileged: false, args: nodejs_packages.unshift(nodejs_version, github_url)
